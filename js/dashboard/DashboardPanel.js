...
// in this panel , we preper the data to be used by the dashboard UI
...
class ModelData {
    ...
    getAllProperyNames(){
        return Object.keys(this._modelData);// in this case we are returning a LIST of property names
    }
}
